  ...
  return (
    <div className="mx-auto max-w-6xl space-y-10 px-4 py-14 md:px-6">
      <div className="max-w-3xl space-y-4">
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-sky-700">Como funciona</p>
      ...
      <div className="grid gap-5">
        {HOW_IT_WORKS_STEPS.map((step, index) => (
          <section key={step.id} className="grid gap-4 rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm md:grid-cols-[88px,1fr] md:items-start">
            <div className="inline-flex h-16 w-16 items-center justify-center rounded-[24px] bg-slate-950 text-lg font-semibold text-white">
              {index + 1}
            </div>
            <div>
