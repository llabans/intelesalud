...
export const SPECIALTY_CATALOG = [
  ...
  },
  {
    ...
    slug: 'neurologia',
    name: 'Neurologia',
    description: 'Evaluacion de cefaleas, migranas, trastornos del movimiento y orientacion neurologica.',
    summary: 'Consulta especializada para sintomas neurologicos, segunda opinion y seguimiento.',
    icon: 'Zap',
  ...
  },
  {
    ...
    description: 'Diagnostico integral del adulto, enfermedades complejas y manejo multisistema.',
    summary: 'El internista coordina el abordaje de patologias multiples y casos complejos.',
    icon: 'Clipboard',
    color: 'from-slate-500/15 to-gray-500/5',
  },
  {
    id: 'spec_pediatric_surgery',
    slug: 'cirugia-pediatrica',
    name: 'Cirugia pediatrica',
    description: 'Orientacion prequirurgica, segunda opinion y seguimiento postoperatorio infantil.',
    summary: 'Consulta virtual con cirujanos pediatricos para planificacion y control.',
    icon: 'Scissors',
    color: 'from-rose-500/15 to-pink-500/5',
  },
  {
    id: 'spec_gastroenterology',
    slug: 'gastroenterologia',
    name: 'Gastroenterologia',
    description: 'Evaluacion de trastornos digestivos, reflujo, colon irritable y hepatopatias.',
    summary: 'Orientacion clinica para sintomas gastrointestinales y lectura de estudios.',
    icon: 'Salad',
  ...
  },
  {
    ...
    slug: 'neumologia',
    name: 'Neumologia',
    description: 'Evaluacion de asma, EPOC, infecciones respiratorias y apnea del sueno.',
    summary: 'Consulta especializada en vias respiratorias, espirometria y seguimiento cronico.',
    icon: 'Wind',
    color: 'from-sky-500/15 to-blue-500/5',
  },
  {
    id: 'spec_rheumatology',
    slug: 'reumatologia',
    name: 'Reumatologia',
    description: 'Atencion de artritis, lupus, fibromialgia y enfermedades autoinmunes.',
    summary: 'Evaluacion y seguimiento de dolor articular y enfermedades reumaticas.',
    icon: 'Bone',
  ...
  },
  {
    ...
    slug: 'urologia',
    name: 'Urologia',
    description: 'Consulta para infecciones urinarias, prostata, litiasis y salud renal.',
    summary: 'Orientacion urologica remota, lectura de estudios y planificacion terapeutica.',
    icon: 'Droplets',
  ...
  },
  {
    ...
    slug: 'oftalmologia',
    name: 'Oftalmologia',
    description: 'Evaluacion de agudeza visual, ojo seco, glaucoma y segunda opinion.',
    summary: 'Teleconsulta oftalmologica para orientacion, recetas y seguimiento.',
    icon: 'Eye',
